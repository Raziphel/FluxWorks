return function(shared)
  ...
  -- Preserve FluxWorks identity without adding components to every recipe family.
  ...
  -- Keep advanced component counts proportional to the surrounding production chain.
  patch_many_recipes({
    "fast-splitter",
    "express-splitter",
    "turbo-splitter",
