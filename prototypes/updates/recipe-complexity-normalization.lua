-- Recipe complexity should come from the production chain, not from asking one
-- machine to accept a shopping list of every lower-level part in that chain.
-- These late selections run after compatibility passes so the final live
-- recipes stay readable even when AAI and Space Age integrations are active.
...
local keep_ingredients = {
  ...
  ["assembling-machine-2"] = { "assembling-machine-1", "electronic-circuit", "motor", "fw-drive-module", "fw-bearing", "fw-circuit-contact" },
  ...
  ["cryogenic-plant"] = { "refined-concrete", "superconductor", "processing-unit", "lithium-plate", "fw-cryo-coil", "fw-thermal-buffer", "fw-kr-steel-pipe" },
  ...
  ["fw-field-winding"] = { "fw-transformer-core", "fw-drive-module", "fw-coil-block", "fw-ribbon-cable", "electric-engine-unit", "fw-power-regulator" },
  ["fw-flow-regulator"] = { "fw-pressure-housing", "fw-drive-module", "fw-bearing", "fw-inline-filter", "fw-copper-tube", "engine-unit" },
  ...
  ["fw-flux-quarry"] = { "electric-mining-drill", "electric-motor", "electric-engine-unit", "fw-pressure-housing", "fw-flow-regulator", "fw-drive-module", "fw-control-assembly" },
  ...
  ["fw-hydraulic-regulator-calibration"] = { "fw-pressure-housing", "fw-drive-module", "fw-bearing", "fw-inline-filter", "fw-copper-tube", "lubricant" },
  ...
  ["fw-power-regulator"] = { "fw-transformer-core", "fw-control-assembly", "fw-capacitor", "silicon", "fw-ceramic-insulator", "electric-motor" },
  ...
  ["fw-sensor-package"] = { "electronic-circuit", "fw-control-assembly", "fw-circuit-substrate", "fw-glass-lens", "silicon", "tin-plate", "fw-capacitor" },
  ["fw-signal-conduit"] = { "fw-control-assembly", "fw-tinned-cable", "fw-copper-tube", "fw-rubber-sheet", "fw-solder-wire", "electric-motor" },
  ...
  ["industrial-furnace"] = { "electric-furnace", "engine-unit", "fw-foundry-lining", "fw-power-regulator", "fw-alumina-refractory", "fw-hydraulic-manifold" },
  ...
  ["oil-refinery"] = { "stone-brick", "electronic-circuit", "fw-steel-beam", "engine-unit", "electric-engine-unit", "fw-drive-module" },
  ...
  ["pumpjack"] = { "electric-motor", "engine-unit", "fw-drive-module", "fw-flow-regulator", "fw-bearing", "pipe" },
...
local function filter_ingredients(recipe_name, ingredients, keep_names)
  ...
  if #filtered ~= #keep_names then
    error(("Recipe complexity normalization for %s expected %d ingredients but found %d"):format(
      recipe_name, #keep_names, #filtered
    ))
  end
  return filtered
end
