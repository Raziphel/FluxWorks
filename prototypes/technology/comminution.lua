data:extend({
  {
    ...
    effects = {
      ...
      { type = "unlock-recipe", recipe = "fw-carbon-refining" },
      { type = "unlock-recipe", recipe = "fw-salt-from-water" },
      { type = "unlock-recipe", recipe = "fw-metallic-beneficiation" },
      { type = "unlock-recipe", recipe = "fw-silicon-beneficiation" },
    },
