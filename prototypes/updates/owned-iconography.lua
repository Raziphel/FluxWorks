...
local technology_icons = {
  ...
  ["fw-aai-bulk-storage"] = { items .. "late-utility/fw-compression-baffle.png", 256 },
  ["fw-aai-network-storage"] = { items .. "late-utility/fw-phase-anchor.png", 256 },
  ["fw-aai-controlled-storage"] = { items .. "late-utility/fw-reservoir-lining.png", 256 },
...
local recipe_icons = {
  ...
  ["fw-coal-to-copper-ore"] = { items .. "fw-crushed-copper-ore-v2.png", 256 },
  ["fw-copper-ore-to-coal"] = { items .. "fw-coal-chips.png", 128 },
  ["fw-copper-ore-to-iron-ore"] = { items .. "fw-crushed-iron-ore-v2.png", 256 },
  ["fw-iron-ore-to-copper-ore"] = { items .. "fw-crushed-copper-ore-v2.png", 256 },
  ["fw-lead-ore-to-iron-ore"] = { items .. "fw-crushed-iron-ore-v2.png", 256 },
  ["fw-titanium-ore-to-uranium-ore"] = { items .. "fw-isotope-matrix.png", 64 },
