return function(shared)
  ...
  if enable_orbital_and_planetary_integration then
    ...
    set_recipe_ingredients("thruster", {
      ...
      { type = "item", name = "fw-pressure-housing", amount = 1 },
      { type = "item", name = "fw-kr-steel-pipe", amount = 6 },
    })
  ...
  -- Second-pass family cleanup.
  -- Keep infrastructure, utility, and combat recipes specialized,
  -- but stop making every late machine feel like a combinatoric assembler test.
