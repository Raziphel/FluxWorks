...
local TRANSMUTATION_BALANCE = {
  ...
  steps = {
    ...
    { from = "coal",        to = "copper-ore",   input_amount = 12, output_amount = 10, flux_cost = 8,  flux_refund = 2,  energy_required = 4 },
    { from = "copper-ore",  to = "iron-ore",     input_amount = 10, output_amount = 10, flux_cost = 6,  flux_refund = 1,  energy_required = 4 },
    { from = "iron-ore",    to = "lead-ore",     input_amount = 12, output_amount = 9,  flux_cost = 14, flux_refund = 4,  energy_required = 6,  unlock_technology = "fw-flux-catalysis", catalyst_amount = 1, catalyst_return_probability = 0.90 },
    { from = "lead-ore",    to = "tin-ore",      input_amount = 12, output_amount = 9,  flux_cost = 16, flux_refund = 5,  energy_required = 6,  unlock_technology = "fw-flux-catalysis", catalyst_amount = 1, catalyst_return_probability = 0.88 },
    { from = "tin-ore",     to = "bauxite-ore",  input_amount = 12, output_amount = 8,  flux_cost = 20, flux_refund = 6,  energy_required = 7,  unlock_technology = "fw-flux-catalysis", catalyst_amount = 1, catalyst_return_probability = 0.85 },
    { from = "bauxite-ore", to = "silicon-ore",  input_amount = 12, output_amount = 8,  flux_cost = 24, flux_refund = 7,  energy_required = 7,  unlock_technology = "fw-flux-catalysis", catalyst_amount = 1, catalyst_return_probability = 0.82 },
    { from = "silicon-ore", to = "titanium-ore", input_amount = 12, output_amount = 7,  flux_cost = 30, flux_refund = 9,  energy_required = 9,  unlock_technology = "fw-flux-field-theory", flux_fluid = "fw-red-flux",    catalyst_amount = 1, catalyst_return_probability = 0.75, secondary_fluids = { { name = "fw-green-flux", amount = 10 } } },
    { from = "titanium-ore", to = "uranium-ore", input_amount = 12, output_amount = 6,  flux_cost = 36, flux_refund = 10, energy_required = 10, unlock_technology = "fw-flux-field-theory", flux_fluid = "fw-yellow-flux", catalyst_amount = 1, catalyst_return_probability = 0.70, secondary_fluids = { { name = "fw-red-flux", amount = 12 } } },
  },
}
