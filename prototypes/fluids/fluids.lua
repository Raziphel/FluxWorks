...
data:extend({
{
  ...
  icon = "__FluxWorksAssets__/graphics/icons/fluids/flux-purple.png",
  icon_size = 256,
...
},
{
  ...
  icon = "__FluxWorksAssets__/graphics/icons/fluids/flux-yellow.png",
  icon_size = 256,
...
},
{
  ...
  icon = "__FluxWorksAssets__/graphics/icons/fluids/flux-red.png",
  icon_size = 256,
...
},
{
  ...
  icon = "__FluxWorksAssets__/graphics/icons/fluids/flux-green.png",
  icon_size = 256,
