...
data:extend({
  ...
  process_tech(
    ...
    "__space-age__/graphics/icons/ice.png",
    64,
  ...
  process_tech(
    ...
    "__FluxWorksAssets__/graphics/icons/items/fw-model-lattice.png",
    64,
  ...
  process_tech(
    ...
    "__FluxWorksAssets__/graphics/icons/items/fw-rocket-chunk-crushing.png",
    64,
