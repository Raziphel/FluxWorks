...
data:extend({
  {
    ...
    results = {
      { type = "fluid", name = "fw-chlorine", amount = 30 },
    },
  ...
  },
  {
    ...
    ingredients = {
      ...
      { type = "fluid", name = "fw-latex", amount = 18 },
    },
    results = {
  ...
  },
  {
    ...
    ingredients = {
      ...
      { type = "fluid", name = "holmium-solution", amount = 8 },
    },
    results = {
  ...
  },
  {
    ...
    results = {
      { type = "fluid", name = "fluoroketone-hot", amount = 90, temperature = 180 },
    },
  ...
  },
  {
    ...
    order = "b[foundry]-d[vulcanus-slag-cermet]",
    enabled = false,
    energy_required = 10.0,
    allow_productivity = true,
    ingredients = {
