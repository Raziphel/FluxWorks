return function(shared)
  ...
  -- Each science pack represents a small number of deliberate production lanes.
  ...
  -- Early and midgame staples remain concise; later recipes carry more of the
  -- FluxWorks component identity.
  ...
  -- Place staged components in the machines that represent their function.
  patch_recipe_set({
    { "lab", "fw-lens-array", 1 },
  ...
  -- Advanced parts belong to their dedicated machine categories.
