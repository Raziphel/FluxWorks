...
local TRANSMUTATION_BALANCE = {
  ...
  steps = {
    { from = "stone",       to = "coal",         input_amount = 10, output_amount = 10, flux_cost = 10,  flux_refund = 10,  energy_required = 5 },
    { from = "coal",        to = "copper-ore",   input_amount = 10, output_amount = 10, flux_cost = 20,  flux_refund = 20,  energy_required = 5, secondary_fluids = { { name = "water", amount = 10 } } },
    { from = "copper-ore",  to = "iron-ore",     input_amount = 10, output_amount = 10, flux_cost = 20,  flux_refund = 20,  energy_required = 5, secondary_fluids = { { name = "water", amount = 10 } } },
    { from = "iron-ore",    to = "lead-ore",     input_amount = 10, output_amount = 10, flux_cost = 30, flux_refund = 30,  energy_required = 5,  unlock_technology = "fw-flux-catalysis", catalyst_amount = 1, catalyst_return_probability = 0.90, secondary_fluids = { { name = "crude-oil", amount = 12 } } },
    { from = "lead-ore",    to = "tin-ore",      input_amount = 10, output_amount = 10, flux_cost = 30, flux_refund = 30,  energy_required = 5,  unlock_technology = "fw-flux-catalysis", catalyst_amount = 1, catalyst_return_probability = 0.88, secondary_fluids = { { name = "crude-oil", amount = 14 } } },
    { from = "tin-ore",     to = "bauxite-ore",  input_amount = 10, output_amount = 10, flux_cost = 40, flux_refund = 40,  energy_required = 5,  unlock_technology = "fw-flux-catalysis", catalyst_amount = 1, catalyst_return_probability = 0.85, secondary_fluids = { { name = "crude-oil", amount = 18 } } },
    { from = "bauxite-ore", to = "silicon-ore",  input_amount = 10, output_amount = 10, flux_cost = 40, flux_refund = 40,  energy_required = 5,  unlock_technology = "fw-flux-catalysis", catalyst_amount = 1, catalyst_return_probability = 0.82, secondary_fluids = { { name = "crude-oil", amount = 22 } } },
    { from = "silicon-ore", to = "titanium-ore", input_amount = 10, output_amount = 10, flux_cost = 50, flux_refund = 50,  energy_required = 5,  unlock_technology = "fw-flux-field-theory", flux_fluid = "fw-red-flux",    catalyst_amount = 1, catalyst_return_probability = 0.75, secondary_fluids = { { name = "crude-oil", amount = 28 }, { name = "fw-green-flux", amount = 10 } } },
    { from = "titanium-ore", to = "uranium-ore", input_amount = 10, output_amount = 10, flux_cost = 100, flux_refund = 100, energy_required = 10, unlock_technology = "fw-flux-field-theory", flux_fluid = "fw-yellow-flux", catalyst_amount = 1, catalyst_return_probability = 0.70, secondary_fluids = { { name = "crude-oil", amount = 36 }, { name = "fw-red-flux", amount = 12 } } },
  },
}
