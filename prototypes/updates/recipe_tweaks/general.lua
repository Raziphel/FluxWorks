return function(shared)
  ...
  -- Electronics join the FluxWorks component ladder from advanced circuits onward.
  patch_recipe_set({
  ...
  -- Space Age machinery follows the same material language.
  ...
  -- Lead belongs to fluid systems; titanium belongs to high-tier structures.
  ...
  -- Component recipes consume refined materials rather than duplicating raw inputs.
  patch_recipe_set({
  ...
  -- Chemistry and fire-control equipment share their dedicated material families.
  ...
  -- Base and Space Age recipe integration.
  patch_many_recipes({
    "fast-transport-belt",
  ...
  -- Orbital hardware and planetary systems.
  if enable_orbital_and_planetary_integration then
    patch_many_recipes({
      "thruster",
      "space-platform-hub",
  ...
  -- Intermediates, combat, logistics, and utility equipment.
  patch_many_recipes({
    "electronic-circuit",
    "advanced-circuit",
    "processing-unit",
  ...
  if enable_combat_recipe_integration then
    ...
    -- Give the raw metals clear jobs without turning ammunition recipes into
    -- shopping lists: lead carries conventional projectiles, aluminum keeps
    -- rockets and fuel tanks light, and titanium takes the railgun stresses.
    set_recipe_ingredients("firearm-magazine", {
      { "lead-plate", 2 },
      { "fw-gunpowder", 2 },
    })
    set_recipe_ingredients("piercing-rounds-magazine", {
      { "firearm-magazine", 2 },
      { "steel-plate", 1 },
      { "copper-plate", 2 },
      { "lead-plate", 1 },
    ...
    set_recipe_ingredients("uranium-rounds-magazine", {
      { "piercing-rounds-magazine", 1 },
      { "uranium-238", 1 },
      { "lead-plate", 1 },
      { "fw-gunpowder", 1 },
    })
    set_recipe_ingredients("shotgun-shell", {
      { "copper-plate", 2 },
      { "lead-plate", 2 },
      { "fw-gunpowder", 1 },
    })
    set_recipe_ingredients("piercing-shotgun-shell", {
      { "shotgun-shell", 2 },
      { "steel-plate", 2 },
      { "lead-plate", 3 },
      { "fw-gunpowder", 1 },
    })
    set_recipe_ingredients("cannon-shell", {
      { "steel-plate", 2 },
      { "lead-plate", 2 },
      { "explosives", 1 },
      { "fw-gunpowder", 1 },
    })
    set_recipe_ingredients("explosive-cannon-shell", {
      { "steel-plate", 2 },
      { "lead-plate", 2 },
      { "explosives", 2 },
      { "fw-gunpowder", 1 },
    ...
    replace_recipe_ingredient("flamethrower-ammo", "steel-plate", {
      type = "item", name = "aluminum-plate", amount = 5,
    })
    replace_recipe_ingredient("railgun-ammo", "steel-plate", {
      type = "item", name = "titanium-plate", amount = 5,
    })
    replace_recipe_ingredient("artillery-shell", "calcite", {
      type = "item", name = "lead-plate", amount = 4,
    })
    replace_recipe_ingredient("capture-robot-rocket", "steel-plate", {
